...
<html>
    <head>
        <title>Cetak Data Rekam Medis Pertahun</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA REKAM MEDIS TAHUN   <?php echo "$ambilthn"; ?></h3>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM rekam_medis WHERE substr(tgl_periksa,1,4)='$ambilthn'";
