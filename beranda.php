    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-warning">
               <marquee> <p style="font-size: 28px">Selamat Datang di SI Puskesmas Air Joman</p></marquee>
            </div>
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-responsive table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th>No.Pasien</th><th width="30%">Nama </th><th>Jenis Kelamin</th><th>Umur</th><th>Tanggal Kunjungan</th><th>alamat</th><th>pekerjaan</th>
                            </tr>
                        </thead>
                        <tbody>
